function name_tag:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    {text: "Name Tag"},\
    {translate: "name_tag.description", fallback: "Adds a crafting recipe + name tags drop from entities when killed"},\
    "",\
    ...
    {text: "modrinth.com/datapack/name-tag", color: "#a800a8"},\
    "",\
    "",\
    "",\
    "",\
